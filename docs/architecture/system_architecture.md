...
That makes feedback more defensible to experts and more useful to learners.
...
* compare automated scores to expert/admin judgments
...
If scoring depends too heavily on heuristics, it may not correlate strongly enough with expert/admin judgment.

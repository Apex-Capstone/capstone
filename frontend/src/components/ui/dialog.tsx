...
/**
 * Radix dialog primitives with overlay, header, title, and description helpers.
 */
...
/** Dimmed full-screen overlay behind modal content. */
...
/** Centered modal panel with built-in close control. */
...
/**
 * Top section of a dialog (title + description stack).
 *
 * @param props - Standard div HTML attributes
 * @returns Header layout wrapper
 */
...
/** Accessible dialog title (Radix Title). */
